...
public class lojaEletrodomestico {
    ...
    public static void main(String[] args) {
        ...
        Cliente c = new Cliente("Ryan Mendes ", "123.052.236-00", 
        ...
        Produto p = new Produto("Televisão 43", 1000.00, 1500.00);
        ...
        p.setPrecoCusto(1500.00);
        p.setPrecoVenda(2000.00);
        System.out.println("Novo preco de custo: " + p.getPrecoCusto());
        System.out.println("Novo preco de venda: " + p.getPrecoVenda());
        System.out.println("");
        
        System.out.println("*** FUNCIONARIO ***");
        Funcionario f = new Gerente("Guilherme Henrique", "123.456.789-10", "Eletrodomésticos", 2500.00);
